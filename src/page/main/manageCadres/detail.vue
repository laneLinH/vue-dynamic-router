      ...
      <div class="cus-print">
        ...
        <table   class="cus-table " width="100%">
          ...
          <tr >
            ...
            <td><span v-if="formData.partyType==='中共党员'">{{formatDate(formData.joinPartyDate)}}</span><span v-else>{{formData.partyType}}</span></td>
